...
const TotalServe = () => {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
    ...
    {/* Registered Rooms */}
    <div className="flex items-center gap-4 justify-start sm:justify-center bg-white  dark:bg-slate-800/50 p-8 rounded-md shadow-md hover:shadow-lg transition duration-300">
      <div className="border border-blue-400 p-3 rounded-full">
        <MdOutlineBedroomParent className="text-Primary" size={35} />
      </div>
    ...
    <div className="flex items-center gap-4 justify-start sm:justify-center  bg-white dark:bg-slate-800/50 p-8 rounded-md shadow-md hover:shadow-lg transition duration-300">
      <div className="border border-blue-400 p-3 rounded-full">
        <FaUserAlt className="text-Primary" size={35} />
      </div>
      <div className="dark:text-white">
    ...
    <div className="flex items-center gap-4 justify-start sm:justify-center  bg-white dark:bg-slate-800/50 p-8 rounded-md shadow-md hover:shadow-lg transition duration-300">
      <div className="border border-blue-400 p-3 rounded-full">
        <FaLocationArrow className="text-Primary" size={35} />
      </div>
      <div className="dark:text-white">
    ...
    <div className="flex items-center gap-4 justify-start sm:justify-center  bg-white dark:bg-slate-800/50 p-8  rounded-md shadow-md hover:shadow-lg transition duration-300">
      <div className="border border-blue-400 p-3 rounded-full">
        <IoMdCall className="text-Primary" size={35} />
      </div>
      <div className="dark:text-white">
